        ...
        <div className="container-max">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center">
              <Link href="/" className="text-2xl font-bold text-primary">SQLOPTIMISE</Link>
            </div>
            <nav className="hidden md:flex space-x-8">
              ...
              <Link href="/blog" className="text-secondary hover:text-primary transition-colors font-semibold">Blog</Link>
      ...
      <main className="section-padding">
        <div className="container-max">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-secondary mb-4">SQL Performance Blog</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Insights, tips, and best practices for SQL Server performance optimization
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-50 rounded-lg p-8 text-center">
              ...
              <h2 className="text-2xl font-semibold text-gray-700 mb-2">Blog Coming Soon</h2>
              <p className="text-gray-600 mb-6">
                We're working on creating valuable content about SQL Server performance optimization, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/company/sqloptimise/" className="text-gray-300 hover:text-white transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                <a href="https://github.com/DEX-CON-ONE" className="text-gray-300 hover:text-white transition-colors">
