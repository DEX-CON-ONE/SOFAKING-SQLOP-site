...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section className="hero-fullscreen min-h-screen flex items-center justify-center text-white">
        <div className="hero-overlay"></div>
        <div className="hero-content container-max text-center px-4">
      ...
      {/* Differentiators with Enhanced Cards */}
      ...
      <section className="section-padding">
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Performance Tuning */}
            <div className="card-elevated p-10 group">
      ...
      <section className="bg-gray-50 section-padding">
        <div className="container-max">
          <div className="scroll-reveal text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Real results from real clients who trust SQLOPTIMISE</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card-elevated p-10">
              <div className="flex items-center mb-8">
                <div className="w-16 h-16 bg-gradient-to-r from-primary to-pink-500 rounded-full flex items-center justify-center mr-6 flex-shrink-0 shadow-lg">
                  <span className="text-white font-bold text-xl">SJ</span>
                </div>
                <div>
                  <h4 className="font-bold text-xl text-gray-900">Sarah Johnson</h4>
                  <p className="text-gray-600 font-medium">CTO, TechCorp</p>
                </div>
              </div>
              <p className="text-gray-700 text-lg leading-relaxed font-medium">
                "SQLOPTIMISE reduced our query response times by 85% in just two weeks. Outstanding results that exceeded all expectations."
              </p>
              <div className="flex mt-6 text-secondary">
                {[...Array(5)].map((_, i) => (
            ...
            <div className="card-elevated p-10">
              <div className="flex items-center mb-8">
                <div className="w-16 h-16 bg-gradient-to-r from-accent to-green-400 rounded-full flex items-center justify-center mr-6 flex-shrink-0 shadow-lg">
                  <span className="text-white font-bold text-xl">MC</span>
                </div>
                <div>
                  <h4 className="font-bold text-xl text-gray-900">Mike Chen</h4>
                  <p className="text-gray-600 font-medium">Database Administrator, DataFlow Inc</p>
                </div>
              </div>
              <p className="text-gray-700 text-lg leading-relaxed font-medium">
      ...
      {/* AI Chat Component - Bottom of page */}
      <section className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12">
        <div className="container-max">
          <div className="card-elevated bg-gradient-to-r from-primary to-secondary p-8 text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <div className="text-left">
                <h3 className="text-2xl font-bold">SQL Performance AI Assistant</h3>
                <p className="text-pink-100">Get instant answers to your SQL optimization questions</p>
              </div>
            </div>
            <p className="text-lg mb-6 max-w-2xl mx-auto text-pink-100">
              Chat with our AI-powered assistant for quick SQL performance tips, optimization advice, and answers to common database issues.
            </p>
            <button className="btn-secondary bg-white text-primary hover:bg-gray-100 inline-flex items-center">
              Start Chat
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
